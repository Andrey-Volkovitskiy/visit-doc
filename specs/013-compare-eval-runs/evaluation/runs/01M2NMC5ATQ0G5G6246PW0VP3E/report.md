# Golden-set report - run 01M2NMC5ATQ0G5G6246PW0VP3E

## Conditions

- Clock: 2026-03-02T08:00:00
- Session: 01M2NMC4RGTJX1C72Q0RQ0PN9R
...
| metric | value | numerator / denominator | excluded |
|---|---|---|---|
| similarity_hit_at_1 | 0.977 | 84 / 86 | handed_off_turn 6 |
| similarity_hit_at_3 | 0.988 | 85 / 86 | handed_off_turn 6 |
| similarity_hit_at_5 | 1.000 | 86 / 86 | handed_off_turn 6 |
| similarity_mrr | 0.985 | 84.750 / 86 | handed_off_turn 6 |
| rerank_hit_at_1 | 0.976 | 83 / 85 | not_reached_reranker 1, handed_off_turn 6 |
| rerank_hit_at_3 | 1.000 | 85 / 85 | not_reached_reranker 1, handed_off_turn 6 |
| rerank_hit_at_5 | 1.000 | 85 / 85 | not_reached_reranker 1, handed_off_turn 6 |
| rerank_mrr | 0.988 | 84.000 / 85 | not_reached_reranker 1, handed_off_turn 6 |
| similarity_gate_survival | 0.988 | 85 / 86 | handed_off_turn 6 |
...
| wrong_abstention_share | 0.217 | 5 / 23 | handed_off_turn 33 |
...
By cause: abstained 5, lost_to_count_mismatch 1, misclassified 0.
...
- G097 [1] abstained at rerank_floor: Does this clinic have a dentist?
...
- G097 [1] at rerank_floor: Does this clinic have a dentist?
...
| verdict_distribution.abstained_similarity_floor | 0.045 | 5 / 112 | handed_off_turn 33 |
| verdict_distribution.abstained_rerank_floor | 0.161 | 18 / 112 | handed_off_turn 33 |

## Booking

| metric | value | numerator / denominator | excluded |
|---|---|---|---|
| tool_selection_correctness | 0.611 | 11 / 18 | - |
| end_to_end_task_success | 0.833 | 15 / 18 | - |
...
- Drive seconds: 638.95
- Score seconds: 0.1709
